...
how to set up:
-The person who wants to set a chat with another person needs to specify the next command chat -S (your ip) -P (your port) -K (the key that the client will need to connect to your server)
...
-In case you want to set up for a group of persons, first of all you will need to specify the next command chat -S (your ip) -P (your port) -All
